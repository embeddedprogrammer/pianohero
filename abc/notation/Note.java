...
//		}
  ...
  /** <TT>true</TT> if this note has been played, <TT>false</TT> otherwise. */
  ...
  {
	 return "" + strictHeight + ", " + octaveTransposition + ", " + m_accidental
			  + ", " + m_duration + ", " + m_invisibleRest + ", " + m_strictDuration;
  }
