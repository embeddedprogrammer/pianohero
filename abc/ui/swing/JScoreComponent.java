...
public class JScoreComponent extends JComponent
	...
	public void setWidthWithMargin(double x)
	{
		double newWidth = x + getTemplate().getAttributeSize(ScoreAttribute.MARGIN_RIGHT);
		if(newWidth > m_dimension.getWidth())
		{
			m_dimension.setSize(newWidth, m_jTune.getHeight());
			setPreferredSize(m_dimension);
			setSize(m_dimension);
			getJTune().setMinStaffWidth(x);			
		}
		m_isBufferedImageOutdated=true;
		repaint();
	}
	
//	public void setBufferedImageOutdated(boolean b)
//	{
//		m_isBufferedImageOutdated = b;		
//	}
